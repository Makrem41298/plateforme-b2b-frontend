...
import LinkVerifedEmail from "./Auth/Client/LinkVerifedEmail.jsx";
...
export const AppRoutes = () => {
    ...
    return (
        <BrowserRouter>
            <Routes>
                <Route path="/" element={tokenEnterprise ? <Layouts /> : <Navigate to={routes.loginEnterprise.path} />}>
                ...
                <Route path={routes.loginClient.path} element={ !tokenClient?<LoginClient />:<Navigate to={routes.client.dashboard} />} />
                ...
                <Route path={routes.verificationEmail.path} element={<VerificationEmailClient />} />
                <Route path={routes.client.verificationClient} element={<LinkVerifedEmail/>}/>
