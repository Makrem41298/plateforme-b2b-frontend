...
const ForgotPasswordEnterprise = () => {
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-400 to-green-500 overflow-hidden">
            <div className="bg-white rounded-xl shadow-lg p-10 w-full max-w-md">
                ...
                <p className="mt-6 text-center text-sm text-gray-600">
                    ...
                    <Link to="/login/entreprise" className="text-green-600 hover:underline font-medium">
                        Return to Login
                    </Link>
                </p>
            </div>
